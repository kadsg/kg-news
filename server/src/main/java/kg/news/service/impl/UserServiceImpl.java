...
public class UserServiceImpl implements UserService {
    ...
    public UserServiceImpl(UserRepository userRepository, RoleMapperRepository roleMapperRepository, UserMapper userMapper) {
    ...
    public PageResult<UserVO> queryUser(UserQueryDTO userQueryDTO) {
        ...
        return new PageResult<>(page, pageSize, users.getTotal(), users.getResult());
    }
